        ...
        {DOWNLOADS.map((target) => (
          <div key={target.id} className="panel p-6">
            ...
            <button
              type="button"
              disabled={!active}
              className="mt-5 inline-flex items-center gap-2 rounded-[10px] bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition-all duration-200 hover:brightness-115 disabled:opacity-50"
            >
